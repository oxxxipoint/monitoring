...
class Specialist(models.Model):
    ...
    def setMarks(self):
        file = open('C:/Users/salae/PycharmProjects/monitoring/specialists/estimations.txt', 'r')
        marks = file.read()
        file.close()
    ...
    def setRanks(self):
        file = open('C:/Users/salae/PycharmProjects/monitoring/specialists/coefficients.txt', 'r')
        file_text = file.read()
        file.close()
        ranks = {}
